...
import { Send, CheckCircle, AlertCircle, MessageCircle, Phone, Mail, MapPin } from 'lucide-react';
  ...
  const contactInfo = [
    {
      ...
      href: generateWhatsAppLink(contactData.whatsapp, contactData.whatsappMessage)
    },
    {
      icon: Mail,
      label: 'Email',
    ...
    >
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            Vamos começar sua{' '}
            <span className="text-teal">transformação</span>
          </h2>
          
          <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto">
            Estou aqui para ajudar você a descobrir seu potencial máximo. 
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      Aceito que meus dados sejam utilizados para entrar em contato comigo 
                      e concordo com a{' '}
